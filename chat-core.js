...
const I18N = {
  fr: {
    ...
    reply_note: 'ℹ Les réponses sont citées directement en arabe (paroles du Dr Dhiaa Al Awadhy). Posez votre question dans la langue de votre choix.',
  ...
  en: {
    ...
    reply_note: 'ℹ Answers are quoted directly in Arabic (Dr Dhiaa Al Awadhy\'s own words). You may ask in any language.',
    source: 'Watch video',
  ...
  ar: {
    ...
    reply_note: 'ℹ الإجابات مقتبسة مباشرةً من كلام الدكتور ضياء العوضي. يمكنك السؤال بأي لغة.',
    source: 'شاهد الفيديو',
